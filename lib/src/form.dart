...
class _FormBasicoState extends State<FormBasico> {
  ...
  void calculateResult(String numero1, String numero2) {
    double parsedNum1 = double.tryParse(numero1) ?? 0;
    double parsedNum2 = double.tryParse(numero2) ?? 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: Color.fromARGB(255, 38, 77, 95),
                ),
                child: Center(
      ...
      floatingActionButton: RawMaterialButton(
        ...
        elevation: 2.0,
        fillColor: Color.fromARGB(255, 81, 127, 173),
